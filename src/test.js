...
// This is Jan's code that I'm trying to modify using promises
// first step was to adjust fetchJSON()
// Still trying to figure out what needs to be modified in main()
